...
function HeaderModeSelector({
  ...
  const currentModeLabel = modeOptionLabel(selectedMode);
  const modeOptions: Array<{ mode: UiMode; label: string }> = [
    { mode: "demo", label: "Demo Mode" },
  ...
  return (
    <div ref={selectorRef} className="relative lg:min-w-0">
      <button
        ...
        title="Choose the data view for this browser session"
      >
          ...
          <span className="inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center">
            <span
              ...
              className={[
                ...
                selectedMode === "live" ? "bg-cyan-300" : "bg-emerald-300",
              ].join(" ")}
            />
          </span>
        </span>
        ...
        >
          ...
          <div className="py-1">
            {modeOptions.map((option) => {
              const isCurrent = option.mode === selectedMode;
